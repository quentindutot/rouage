...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', href: '/rouage.svg' }],
    ['meta', { name: 'description', content: 'Minimal Solid SSR' }],
    ...
    ['meta', { property: 'twitter:domain', content: 'rouage.dev' }],
    ['meta', { property: 'twitter:url', content: 'https://rouage.dev' }],
    ['meta', { name: 'twitter:title', content: 'Minimal Solid SSR - Rouage' }],
    ['meta', { name: 'twitter:description', content: 'Minimal Solid SSR' }],
